...
function initializeAdSquares(map: L.Map): void {
    ...
    const popupContent = `<h3>Исходный код приложения доступен на <a href="https://github.com/keepaliveodessa/survival_map" target="_blank">GitHub</a></h3><br>поблагодарить разработчика можно на <a href="https://bastyon.com/keep_alive_odessa?ref=PHQHKADhBPxxSwjiggV6G2BxSvy6TY1Lgb" target="_blank">bastyon</a>`;
